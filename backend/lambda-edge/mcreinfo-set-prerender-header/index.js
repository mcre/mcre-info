...
// 更新した場合はCloudFrontのビヘイビア設定からLambdaのArnのバージョンを手動で変更する必要があるので注意
'use strict'
  ...
  if (user_agent && host) {
    ...
    if (prerender) {
      headers['x-prerender-token'] = [
        { key: 'X-Prerender-Token', value: 'i3GxXWGm2hmzAWQvN2xk' }
      ]
